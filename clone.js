...
let select1 = document.getElementById('queryInput1');
let select2 = document.getElementById('queryInput2');
let Enquiry = document.getElementById('generalEn');
let Support = document.getElementById('supportRe');
